...
public class WalletControllerUnitTest {
        ...
        class AddPurchase {
                ...
                void shouldBeAbleToAddPurchaseOfAssetToWalletWithValidPayload() {
                        ...
                        ResponseEntity<WallerSuccessResponseDto> response = walletController.addPurchase(TOKEN,
                                        payload);
                ...
                void shouldNotBeAbleToAddPurchaseOfAssetToWalletWithInvalidPayload() {
                        ...
                        assertTrue(violations.stream()
                                        .anyMatch(v -> v.getMessage().equals(
                                                        "O número de cotas compradas deve ser maior que zero")));
                        assertTrue(violations.stream()
                                        .anyMatch(v -> v.getMessage()
                                                        .equals("O preço da compra deve ser maior que zero")));
                        assertTrue(violations.stream()
                                        .anyMatch(v -> v.getMessage()
                                                        .equals("A data da compra deve ser anterior a data corrente")));
                }
        }
        ...
        class AddManyPurchasesByCSV {
                ...
                void shouldBeAbleToAddManyPurchasesOfAssetToWalletByUsingFile() {
                        ...
                        ResponseEntity<WallerSuccessResponseDto> response = walletController
                                        .addManyPurchasesByCSV(TOKEN, file);
        ...
        class UpdatePurchase {
                ...
                void shouldNotBeAbleToUpdatePurchaseOfAssetInWalletWithInvalidPayload() {
                        ...
                        assertTrue(violations.stream()
                                        .anyMatch(v -> v.getMessage()
                                                        .equals("A data da compra não pode ser no futuro")));
                }
        }
        ...
        class AddSale {
                ...
                void shouldNotBeAbleToAddSaleOfAssetFromWalletWithInvalidPayload() {
                        ...
                        assertTrue(violations.stream()
                                        .anyMatch(v -> v.getMessage()
                                                        .equals("O número de cotas vendidas deve ser maior que zero")));
                        assertTrue(violations.stream()
                                        .anyMatch(v -> v.getMessage()
                                                        .equals("O preço da venda deve ser maior que zero")));
                        assertTrue(
                                        violations.stream().anyMatch(v -> v.getMessage()
                                                        .equals("A data da venda não pode ser no futuro")));
                }
        }
        ...
        class AddManySalesByCSV {
                ...
                void shouldBeAbleToAddManySalesOfAssetToWalletByUsingFile() {
                        ...
                        ResponseEntity<WallerSuccessResponseDto> response = walletController.addManySalesByCSV(TOKEN,
                                        file);
